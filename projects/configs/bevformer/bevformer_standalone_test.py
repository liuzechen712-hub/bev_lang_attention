...
data_root = '/home/lzc/data/drivelm_nuscenes'
...
train_pipeline = [
    ...
    dict(type='Collect3D', keys=['gt_bboxes_3d', 'gt_labels_3d', 'img'],
         meta_keys=['img_filename', 'ori_shape', 'img_shape', 'lidar2img',
                    'pad_shape', 'scale_factor', 'flip', 'cam_intrinsic',
                    'cam2img', 'lidar2cam', 'lidar2ego', 'ego2global',
                    'timestamp', 'prev_bev_exists', 'can_bus',
                    'scene_token', 'frame_idx', 'sample_idx'])
]
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/home/lzc/BEVFormer/data/nuscenes/infos_train_filtered.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/home/lzc/BEVFormer/data/nuscenes/infos_val_filtered.pkl',
        pipeline=[],
        classes=['car', 'truck', 'construction_vehicle', 'bus', 'trailer', 'barrier', 'motorcycle', 'bicycle', 'pedestrian', 'traffic_cone'],
        modality=dict(use_lidar=False, use_camera=True),
        test_mode=True,
